...
var _reactNativeAxios = __webpack_require__(34);

var _reactNativeAxios2 = _interopRequireDefault(_reactNativeAxios);

var _application = __webpack_require__(50);

var _application2 = _interopRequireDefault(_application);

var _ArticleIndex = __webpack_require__(55);
...
var Index = function (_React$Component) {
    ...
    function Index(props) {
        ...
        Index.itemDelete = Index.itemDelete.bind(_this);
        _this.state = {
    ...
    _createClass(Index, [{
        ...
        value: function componentDidMount() {
            ...
            this.callApi().then(function (res) {
                return _this2.setState({ articles: res.articles });
            }).catch(function (err) {
        ...
        key: 'callApi',
        value: async function callApi() {
            var response = await fetch('/articles/index');
        ...
        value: function render() {
            ...
            var articles = this.state.articles.map(function (article, key) {
                return _react2.default.createElement(_ArticleIndex2.default, { article: article, key: key, itemDelete: Index.itemDelete });
            });
        ...
        key: 'itemDelete',
        value: function itemDelete(id, index) {
            _reactNativeAxios2.default.delete('articles/' + id);
            var updatedArticles = this.state.articles.filter(function (article, key) {
                return index !== key;
            });
            this.setState({
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "span",
                        { className: "item-delete", onClick: this.handleDelete.bind(this) },
                        " X "
                    )
                )
            );
