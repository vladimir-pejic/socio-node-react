...
var _ArticleIndex = __webpack_require__(32);
...
var Index = function (_React$Component) {
    ...
    function Index(props) {
        ...
        _this.itemDelete = _this.itemDelete.bind(_this);
        _this.state = {
    ...
    _createClass(Index, [{
        ...
        key: 'itemDelete',
        value: function itemDelete(index) {
        ...
        value: function render() {
            ...
            var articles = this.state.articles.map(function (article, key) {
                return _react2.default.createElement(_ArticleIndex2.default, { article: article, key: key, itemDelete: _this3.itemDelete });
            });
